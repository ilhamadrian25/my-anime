                ...
                <div class="card card-body mt-4">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-1">
                            <h6 class="mb-2">Edit Country</h6>
                            <p class="text-sm mb-0"><b>Note</b>: halama ini telah direlasikan , harap tinjau kembali</p>
                        </div>
                        <div class="col-auto my-4">
                            <a href="{{ route('country.index') }}" class="btn btn-primary add-list"><i
                                    class="fa fa-table me-3"></i>Country</a>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <button type="button" name="button" class="btn btn-light m-0"><a href="{{ route('country.index') }}">Batal</button>
