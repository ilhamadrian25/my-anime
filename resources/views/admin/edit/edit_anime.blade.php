...
@section('content')
    ...
    @endforeach
    <form action="{{ route('detail.update', $anime->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('Patch')
        <div class="col-lg-9 col-12 mx-auto">
            <div class="card card-body mt-4">
                <div class="row align-items-center justify-content-between">
                    ...
                    <input type="text" class="form-control" id="nama_jepang" name="nama_jepang" value="{{ $anime->nama_jepang }}" autocomplete="off"
                    ...
                    <input type="text" class="form-control" id="nama_inggris" name="nama_inggris" value="{{ $anime->nama_inggris }}" autocomplete="off"
                ...
                <input type="text" class="form-control" id="tanggal" name="tanggal" value="{{ $anime->tanggal }}" autocomplete="off"
                ...
                <input type="text" class="form-control" id="durasi" name="durasi" value="{{ $anime->durasi }}" autocomplete="off"
                ...
                <div>
                    <textarea class="summernote-container form-control" rows="10" maxlength="200" name="sinopsis" id="editor">{{ $anime->sinopsis }}</textarea>
